...
- image:https://img.shields.io/badge/V1-red?style=flat&label=Documentation%20Technique[Static Badge, Link=="https://github.com/Iamkylian/SAE-ALT-BUT3B01/tree/main/Documentation/Documentation-Technique.adoc"]
