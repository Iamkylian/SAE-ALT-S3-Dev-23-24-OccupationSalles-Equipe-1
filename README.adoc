...
- Version courante de l'application : image:https://img.shields.io/badge/RoomService-v1.0-red.svg[link="https://github.com/Iamkylian/SAE-ALT-S3-Dev-23-24-OccupationSalles-Equipe-1/releases/tag/V2"]
- image:https://img.shields.io/badge/Documentation_Technique-V2-red.svg[link="https://github.com/Iamkylian/SAE-ALT-S3-Dev-23-24-OccupationSalles-Equipe-1/tree/main/Documentation/Documentation-Technique.adoc"]
- image:https://img.shields.io/badge/Documentation_Utilisateur-V2-red.svg[link="https://github.com/Iamkylian/SAE-ALT-S3-Dev-23-24-OccupationSalles-Equipe-1/tree/main/Documentation/Documentation-Utilisateur.adoc"]
...
- image:https://img.shields.io/badge/Cahier_de_tests-RoomService-red.svg[link='https://github.com/Iamkylian/SAE-ALT-S3-Dev-23-24-OccupationSalles-Equipe-1/blob/main/Documentation/Cahier-Tests.adoc'] +
