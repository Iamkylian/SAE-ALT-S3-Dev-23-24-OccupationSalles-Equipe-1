...
.2) Selectionner une salle dans le menu déroulant "Choisir Salle"- Statistique
image::[]

Selectionner une date et une heure dans les champs « Date et Heure ».

.3) Selectionner dans champ  le calendrier la date et l'heure - Statistique
...
.2) Graphique des données - Statistique
image::[]
...
.2) Bâtiment B, 1er étage - Maintenance
image::[]

Deplacer vous sur la salle souhaité - Maintenance
Vous pouvez visualiser l'etat de batterie des capteurs en passant votre souris sur les salles.

Vous pouvez revenir en arriére en cliquant sur la fléche en haut a gauche de l'écran, ou en cliquant sur "Carte" ou "Statistique" dans la barre de navigation.
