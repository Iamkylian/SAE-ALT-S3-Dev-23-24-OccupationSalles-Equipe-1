...
^|All_G_C.3 ^|Deplacer votre souris sur une salle ^| La salle se colore en fonction de l'etat de batterie du capteur présent dans la salle^| Etre précédement sur la page d'acceuil  ^|OK
