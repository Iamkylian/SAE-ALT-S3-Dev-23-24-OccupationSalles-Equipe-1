...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|All_G_C.1 ^|Cliquer sur "Statistiques" ^|La fenêtre de statistique des salles s'ouvre ^| aucune ^|OK
^|All_G_C.2 ^|Cliquer sur le menu déroulant et selectionner une salle spécifique ^| Les graphique apparaissent avec les dernieres valeurs collectés ^| aucune ^|OK
...
^|All_G_C.2 ^|Cliquer sur le menu déroulant et selectionner une salle spécifique ^| Les graphique apparaissent avec les dernieres valeurs collectés ^| aucune ^|OK
^|All_G_C.3 ^|Selectionner dans le champ de type caldendrier une date et une heure ^| Le calendrier apparait pour selectionner un jour et l'heure^|aucune ^|OK
^|All_G_C.4 ^|Cliquer sur le bouton "Générer un rapport PDF" ^|Un rapport PDF est généré avec les informations de la salle selectionné^|aucune ^|OK
