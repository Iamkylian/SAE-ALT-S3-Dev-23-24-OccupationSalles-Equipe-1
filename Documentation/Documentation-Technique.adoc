...
image::Images/Use-Case/visualiserInformationCapteurTempsRéelSalle.png[]
...
.Use Case : 
image::Images/Use-Case/visualiserInformationTempsRéelSalle.png[]
...
.Use Case : 
image::Images/Use-Case/visualiserTempsRéelSalle.png[]
