...
* Responsabilités :
** L'utilisateur doit pouvoir avoir accès aux informations des salles du premier étage du département informatique en temps réel.
** L'utilisateur doit pouvoir avoir accès à l'historique des informations des salles du premier étage du département informatique.
** L'utilisateur doit pouvoir avoir accès aux statistiques des informations des salles du premier étage du département informatique.
** L'utilisateur doit pouvoir avoir accès aux rapports des informations des salles du premier étage du département informatique.
...
===== Python
* Version 3.*
** Afin de pouvoir se connecter à au flux MQTT et pouvoir récupérer les données transmises par les capteurs.

===== Docker
* v24.0.7
** Afin que les utilisateurs puissent utiliser cette application de visualisation de l'état des capteurs et des salles, il est nécessaire de s'assurer que leurs postes de travail disposent de la version de ``Docker Desktop v24.0.7``.. Cela garantira que l'environnement d'exécution Python requis est correctement installé sur leur machine, permettant ainsi de lancer et d'exécuter l'application de manière optimale.
